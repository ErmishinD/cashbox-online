    ...
    <form @submit.prevent="submitLogin">
        <div>
            ...
            <div>
                ...
                <input v-model="loginForm.email" id="email" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required autofocus autocomplete="username">
                <!-- Validation Errors -->
